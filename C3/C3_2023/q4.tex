...
\begin{parts}
	...
	\begin{equation*}
		\mathcal{H} = \sum_{i, j} \frac{J}{2} \mathbf{S}_i \cdot \mathbf{S}_j - \sum_{i} D\rbracket{S_i^z}^2
	\end{equation*}
	...
	\begin{align*}
		...
		&= -g \bohrmagneton  S \sin\theta \cdot B \textnormal{\hspace{1em}due to electron having negative charge}
	\end{align*}
	
	So total energy per site is:
	\begin{equation*}
		E = -\frac{n}{2} JS^2 \cos 2\theta - g \bohrmagneton  SB \sin\theta - DS^2 \cos^2 \theta
	\end{equation*}
	
	At stationary state:
	\begin{align*}
		\pderi{E}{\theta} = 0 \qquad\qquad & \\
		\Rightarrow nJS^2 \sin 2\theta - g \bohrmagneton  BS \cos\theta + 2DS^2 \cos\theta &= 0 \\
		\cos\theta \sbracket{2nJS^2 \sin\theta - g \bohrmagneton  BS + 2DS^2 \sin\theta} &= 0 \\
		\cos\theta = 0 \qquad \textnormal{or} \qquad &\sin\theta = \frac{g \bohrmagneton  BS}{2nJS^2 + 2DS^2} \\
		\qquad &\sin\theta = \frac{g \bohrmagneton  B}{2S\rbracket{nJ + D}}
	\end{align*}
	
	So magnetisation along field per spin:
	\begin{align*}
		M &= -g \bohrmagneton  S \sin\theta \\
		&= -\frac{\rbracket{g \bohrmagneton}^2}{2\rbracket{nJ + D}} \cdot B
	\end{align*}
	...
	\begin{align*}
		E_\textnormal{sf} &= \frac{n}{2} JS^2 - DS^2 - g \bohrmagneton  BS \\
		\Rightarrow B_\textnormal{sf} &= \frac{nJS}{g \bohrmagneton}
	\end{align*}
	
	\part We know that the slope of the graph for the case $B \bot c$ is:
	\begin{equation*}
		\frac{\rbracket{g \bohrmagneton}^2}{2\rbracket{nJ + D}} = \frac{1 \cdot \bohrmagneton}{\SI{8}{\tesla}}
	\end{equation*}
