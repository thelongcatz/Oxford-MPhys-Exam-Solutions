...
\begin{parts}
	...
	\begin{equation*}
		\kappa_{ij}^\prime = \dfrac{\partial x_i^\prime}{\partial x_a} \dfrac{\partial x_j^\prime}{\partial x_b} \kappa_{ab}
	\end{equation*}
	...
	\begin{align*}
		\kappa_\mathbf{u} &\equiv \frac{\mathbf{j}_\textnormal{h} \cdot \hat{\mathbf{u}}}{\left|\nabla T\right|} \\
		&= \frac{-\kappa \bm{\nabla}T \cdot \hat{\mathbf{u}}}{\left|\nabla T\right|} \\
		&= \frac{\left[\kappa \bcancel{\left|\nabla T\right|} \hat{\mathbf{u}}\right] \cdot \hat{\mathbf{u}}}{\bcancel{\left|\nabla T\right|}} \\
		&= \begin{pmatrix}
	...
	\begin{align}
		\kappa_{\left[1 1 0\right]} &= \left(\frac{a}{\sqrt{a^2 + b^2}}\right)^2 \kappa_{xx} + \left(\frac{b}{\sqrt{a^2 + b^2}}\right)^2 \kappa_{yy} + 0 \notag \\
	...
	Similarly,
	\begin{align}
		\kappa_{\left[1 \bar{2} 0\right]} &= \left(\frac{a}{\sqrt{a^2 + 4b^2}}\right)^2 \kappa_{xx} + \left(\frac{2b}{\sqrt{a^2 + 4b^2}}\right)^2 \kappa_{yy} + 0 \notag \\
		&= \SI{28.1}{\watt\per\metre\per\kelvin} = \frac{a^2 \kappa_{xx} + 4b^2 \kappa_{yy}}{a^2 + 4b^2}
		\label{eqn:q6-kappa-1-20}
	\end{align}
	\begin{align}
		\kappa_{\left[0 0 1\right]} &= 0 + 0 + \left(\frac{c}{\sqrt{c^2}}\right) \kappa_{zz} \notag \\
	...
	Hence the velocity of sound along each principal axis is ($\omega = 2\pi\left(\SI{1.0e12}{\hertz}\right) = \SI{6.28e12}{\radian\per\second}$):
	\begin{align*}
		v_1 &= \frac{\omega}{k_1} \\
