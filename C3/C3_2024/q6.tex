...
\begin{parts}
	...
	\begin{subparts}
		...
		\begin{align*}
			...
			&= \rbracket{ 1 + \mathrm{e}^{i\pi(h+k+l)} } \sbracket{
			b_\textnormal{Ca}
			+ b_\textnormal{Fe} \rbracket{ \mathrm{e}^{i\pi(h+l/2)} - \mathrm{e}^{i\pi(h-l/2)} }
			+ b_\textnormal{As} \rbracket{ \mathrm{e}^{i\pi lz} - \mathrm{e}^{-i\pi lz} }
			} \\
			&= \rbracket{ 1 + \mathrm{e}^{i\pi(h+k+l)} } \sbracket{ b_\textnormal{Ca}
			+ 2ib_\textnormal{Fe} \mathrm{e}^{i\pi h} \sin\rbracket{\frac{l}{2}}
			+ 2ib_\textnormal{As} \sin\rbracket{lz}
			}
		\end{align*}
