...
\begin{parts}
	...
	\begin{align}
		...
		&= 6 \times \frac{J}{2} \times \rbracket{-S^2} \notag \\
	...
	\begin{align}
		M &= \frac{4 g \mu_B S}{\rbracket{2a}^3} \notag \\
		&= \frac{g \mu_B S}{2a^3}
	...
	\begin{equation*}
		\lambda = \frac{6Ja^3}{\rbracket{g \mu_B}^2}
	\end{equation*}
	...
	\begin{align}
		...
		&= \frac{g \mu_B S}{2a^3} \frac{S+1}{3S} \frac{g \mu_B S}{k_B T_\textnormal{N}} \rbracket{ \frac{6Ja^3}{\rbracket{g \mu_B}^2} M_\textnormal{A} } \notag \\
		\Rightarrow T_\textnormal{N} &= \frac{JS\rbracket{S+1}}{k_B}
		\label{eqn:q4-tn}
	\end{align}
	
	\newpage
	\part From the graph, we see that the maximum energy occurs at $\rbracket{\frac{1}{2},\, \frac{1}{2},\, 0}$. This corresponds to $\gamma_\mathbf{k} = \sbracket{-1-1+1}/3 = -\diagfrac{1}{3}$. Hence
	\begin{gather}
	...
	Sketch of dispersion for path $\rbracket{ 0,\, 0,\, \frac{1}{2}} \rightarrow \rbracket{0,\, 0,\, 0} \rightarrow \rbracket{\frac{1}{2},\, \frac{1}{2},\, \frac{1}{2}}$ by tracing out the cosine term:
	\begin{gather*}
		\gamma_\mathbf{k} = 
		\begin{cases}
	...
	\begin{align*}
		...
		&\approx 6SJ \sqrt{1 - \rbracket{1 - \frac{|\mathbf{k}|^2 a^2}{3}}} \textnormal{\hspace{1em}ignoring higher order terms} \\
		&= 6SJ \frac{|\mathbf{k}| a}{\sqrt{3}} \\
		\Rightarrow \omega_\mathbf{k} &\approx \underbracket{\frac{6SJa}{\sqrt{3}\hbar}}_{c} \abs{\mathbf{k}}
	\end{align*}
	
	Energy of an ensemble of spin waves, with $n_\textnormal{B} = [\exp(E/k_\textnormal{B} T) - 1]^{-1}$ being the Bose occupation factor:
	\begin{equation*}
		E = \defint{0}{\infty}{g(E) \, n_\textnormal{B} \, E}{E}
	\end{equation*}
	
	Assuming isotropy, we then have the following d.o.s. due to the linear dispersion:
	\begin{align*}
		g(k) \inftsml{k} &= \frac{2}{(2\pi)^3}\, 4\pi k^2 \inftsml{k} \\
		&= \frac{2}{(2\pi)^3}\, 4\pi \rbracket{\frac{E}{\hbar c}}^2 \frac{\inftsml{E}}{\hbar c} \\
		&= \frac{1}{\pi^2 \hbar^3 c^3}\, E^2 \inftsml{E} \\
		&= g(E) \inftsml{E}
	\end{align*}
	
	Thus the total energy is
	\begin{align}
		E &= \int_{0}^{\infty} \inftsml{E} \, \frac{1}{\pi^2 \hbar^3 c^3} E^2 \, \frac{1}{\exp(E/k_\textnormal{B} T) - 1} \, E \notag \\
		&= \frac{1}{\pi^2 \hbar^3 c^3} \int_{0}^{\infty} \frac{E^3}{\exp(E/k_\textnormal{B} T) - 1} \inftsml{E} \notag \\
		&= \frac{1}{\pi^2 \hbar^3 c^3} \int_{0}^{\infty} \rbracket{k_\textnormal{B} T}^4 \frac{x^3}{\exp(x) - 1} \inftsml{x} \textnormal{\hspace{1em}where $x=E/k_B T$} \notag \\
