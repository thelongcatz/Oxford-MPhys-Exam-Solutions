...
\begin{parts}
	...
	\begin{subparts}
		...
		\begin{align*}
			...
			&= \alpha \left(\frac{\ket{+} + \ket{-}}{\sqrt{2}}\right) + \beta \left(\frac{\ket{+} - \ket{-}}{\sqrt{2}}\right) \\
			&= \frac{\alpha + \beta}{\sqrt{2}}\ket{+} \;+\; \frac{\alpha - \beta}{\sqrt{2}}\ket{-} \\[1em]
			\Rightarrow P(+) &= \left|\frac{\alpha + \beta}{\sqrt{2}}\right|^2 = \frac{1}{2} \left|\alpha + \beta\right|^2 \\
			P(-) &= \frac{1}{2} \left|\alpha - \beta\right|^2
		\end{align*}
