...
\begin{parts}
	...
	Note that in optics the correspondence are $\cbracket{\ket{\mathrm{H}^\prime},\,\ket{\mathrm{V}^\prime}}\equiv$ linear polarisation \SI{45}{\degree} to the $\cbracket{\ket{\mathrm{H}},\,\ket{\mathrm{V}}}$ axes, and $\cbracket{\ket{\mathrm{R}},\,\ket{\mathrm{L}}}\equiv$ right/left-handed polarisation.
	...
	\part $\ket{\textnormal{GHZ}} = \diagfrac{1}{\sqrt{2}}\sbracket{\ket{\textnormal{HHH}}-i\ket{\textnormal{VVV}}}$
	
	Noting orthogonality between the basis, we have:
	\begin{gather*}
		P(\textnormal{HHH}) = P(\textnormal{VVV}) = \abs{\frac{1}{\sqrt{2}}}^2 = \abs{-\frac{i}{\sqrt{2}}}^2 = \frac{1}{2} \\
	...
	\begin{align*}
		\textnormal{So } \ket{\textnormal{GHZ}} &= \frac{1}{\sqrt{2}} \sbracket{\rbracket{\frac{\ket{\mathrm{H}^\prime} + \ket{\mathrm{V}^\prime}}{\sqrt{2}}}^{\otimes 2} \rbracket{\frac{\ket{\mathrm{R}} + \ket{\mathrm{L}}}{\sqrt{2}}}
		-i \rbracket{\frac{\ket{\mathrm{H}^\prime} - \ket{\mathrm{V}^\prime}}{\sqrt{2}}}^{\otimes 2} \rbracket{-i\frac{\ket{\mathrm{R}} - \ket{\mathrm{L}}}{\sqrt{2}}}} \\
	...
	\begin{equation*}
		\ket{\textnormal{GHZ}} = \frac{1}{4} \Bigl[\rbracket{\ket{\mathrm{R}}+\ket{\mathrm{L}}}\rbracket{\ket{\mathrm{R}}+\ket{\mathrm{L}}}\rbracket{\ket{\mathrm{R}}+\ket{\mathrm{L}}}
		-i\rbracket{\ket{\mathrm{R}}-\ket{\mathrm{L}}}\rbracket{\ket{\mathrm{R}}-\ket{\mathrm{L}}}\rbracket{\ket{\mathrm{R}}-\ket{\mathrm{L}}}\rbracket{-i}^3\Bigr]
	\end{equation*}
