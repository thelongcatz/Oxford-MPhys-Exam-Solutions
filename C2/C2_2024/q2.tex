...
\begin{parts}
	...
	\begin{align}
		\pderi{A_3}{x} &= \beta A_1^2 \exp(-i\Delta kx) \notag \\
		\Rightarrow A_3 (x) - A_3 (0) &= \beta A_1^2 \frac{\exp(-i\Delta kx) - \exp(0)}{-i\Delta k} \notag \\
		A_3 (x)&= \beta A_1^2 \frac{\exp(-i\Delta kx) - 1}{-i\Delta k} \notag \\
		&= \beta A_1^2 \exp\rbracket{\frac{-i\Delta k x}{2}} \frac{\sin\rbracket{\frac{\Delta kx}{2}}}{i\Delta k} \notag \\
		&= 2\beta A_1^2 \exp\rbracket{\frac{-i\Delta k x}{2}} x\, \textnormal{sinc}\rbracket{\frac{\Delta kx}{2}}
		\label{eqn:q2-a3-x}
	\end{align}
	...
	\begin{gather}
		\sin \rbracket{\frac{\Delta kx}{2}} = 1 \notag \\
	...
	\begin{align*}
		...
		&= \rbracket{\frac{d_{33}}{d_{31}}}^2 \\
		&= \rbracket{\frac{d_{33} / \epsilon_0}{d_{31} / \epsilon_0}}^2 = 32.3
	\end{align*}
