...
\begin{parts}
	...
	\begin{align*}
		S(\textnormal{A}) = S(\textnormal{B}) &= -\textnormal{tr}\sbracket{  \textnormal{diag}\rbracket{\diagfrac{3}{4},\, \diagfrac{1}{4}} \cdot \textnormal{diag}\rbracket{\log_2 \rbracket{ \diagfrac{3}{4}},\, \log_2 \rbracket{\diagfrac{1}{4}}} } \\
		&= -\textnormal{tr}\sbracket{ \textnormal{diag}\rbracket{-0.311,\, -0.5} } \\
		&= 0.811
	\end{align*}
	...
	\begin{align*}
		\rho_\textnormal{B} &= \textnormal{diag}\rbracket{\diagfrac{1}{2},\, \diagfrac{1}{2}} \\
		&= \frac{1}{2} \ket{0}\bra{0} + \frac{1}{2} \ket{1}\bra{1}
	\end{align*}
	
	\part The corresponding entropy for Bob's qubit would then be:
	\begin{align*}
		S(\textnormal{B}) &= -\textnormal{tr}\sbracket{ \textnormal{diag}\rbracket{\diagfrac{1}{2},\, \diagfrac{1}{2}} \cdot \textnormal{diag}\rbracket{\log_2 \rbracket{\diagfrac{1}{2}},\, \log_2 \rbracket{\diagfrac{1}{2}}} } \\
		&= -\textnormal{tr}\sbracket{ \textnormal{diag}\rbracket{-0.5,\, -0.5} } \\
		&= 1
	\end{align*}
